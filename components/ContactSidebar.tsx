    ...
    const links = [
        {
            label: 'Connect',
            name: 'LinkedIn',
            href: 'https://www.linkedin.com/in/aryn-keenan-b1b5b6252/',
            icon: (
        ...
        {
            label: 'Email',
            name: 'arynkeenan@icloud.com',
            href: ['mailto', ':', 'arynkeenan', '@', 'icloud.com'].join(''),
            icon: (
        ...
        },
        {
            label: 'Follow',
            name: 'Instagram',
            href: 'https://instagram.com/arynkeenan',
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
